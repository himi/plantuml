...
public interface PlantumlConstants {
    ...
    public static final String DEFAULTLINE_BUTTON = "Default line style";
    public static final String POLYLINE_BUTTON = "Polyline style";
    public static final String ORTHOGONAL_LINE_BUTTON = "Orthogonal line style";
